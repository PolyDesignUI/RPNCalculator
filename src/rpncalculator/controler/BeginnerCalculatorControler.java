...
public class BeginnerCalculatorControler extends BasicCalculatorControler {

    private BeginnerCalculatorView theBeginnerView;
    public BeginnerCalculatorControler(Calculatrice theCalculatrice, BasicCalculatorView basicCalculatorView, BeginnerCalculatorView theBeginnerView) {
        super(theCalculatrice, basicCalculatorView);
